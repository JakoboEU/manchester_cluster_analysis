...
```{r}
write_csv(insects_k9$sign, 'output/insect_indicator_species_9.csv')
```
...
bind_rows(
  ...
  indicator_species_stats(9, insects_species_only_k9),
...
write_csv(insects_species_only_k9$sign, 'output/insect_no_non_species_indicator_species_9.csv')
```
...
```{r}
write_csv(plants_k9$sign, 'output/plant_indicator_species_9.csv')
```
...
```{r}
write_csv(birds_k9$sign, 'output/bird_indicator_species_9.csv')
```
