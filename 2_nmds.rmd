...
ggplot(data = insect2_site_scores, aes(NMDS1, NMDS2, colour = as.factor(`8`))) +
  ...
  theme_minimal() +
  theme(text = element_text(size = 8)) +
  labs(colour = "cluster", title = 'Insect NMDS', subtitle = paste('no generic taxa groups, clusters=8, stress=', round(insect2_nmds$stress, 3)))
...
ggplot(data = insect2_site_scores, aes(NMDS1, NMDS2, colour = as.factor(`9`))) +
  ...
  theme_minimal() +
  theme(text = element_text(size = 8)) +
  labs(colour = "cluster", title = 'Insect NMDS', subtitle = paste('no generic taxa groups, clusters=9, stress=', round(insect2_nmds$stress, 3)))
```
...
ggplot(data = insect3_site_scores, aes(NMDS1, NMDS2, colour = as.factor(`8`))) +
  ...
  theme_minimal() +
  theme(text = element_text(size = 8)) +
  labs(colour = "cluster", title = 'Insect NMDS', subtitle = paste('no generic taxa groups and no generic bumblebee groups, clusters=8, stress=', round(insect3_nmds$stress, 3)))
...
ggplot(data = insect3_site_scores, aes(NMDS1, NMDS2, colour = as.factor(`9`))) +
  ...
  theme_minimal() +
  theme(text = element_text(size = 8)) +
  labs(colour = "cluster", title = 'Insect NMDS', subtitle = paste('no generic taxa groups and no generic bumblebee groups, clusters=9, stress=', round(insect3_nmds$stress, 3)))
